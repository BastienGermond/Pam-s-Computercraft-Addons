package fr.eagle_fire78.addons.util;
...
public class TurtleUtil {
	...
	public static void addToInv(ITurtleAccess turtle, ItemStack stack) {
		...
		if (drop) {
			...
			turtle.getWorld()
			        .spawnEntityInWorld(new EntityItem(turtle.getWorld(), coords.posX + Facing.offsetsXForSide[dir],
			                coords.posY + Facing.offsetsYForSide[dir] + 1, coords.posZ + Facing.offsetsZForSide[dir],
			                stack.copy()));
		}
	}

	/**
	 * Adds a list of items to the turtle's inventory Credit: austinv11
	 * 
	 * @param items
	 * @param turtle
	 */
	...
	/**
	 * Gets the closest entity to a turtle Modified from functions by austinv11
	 * on 1/28/2016
	 * 
	 * @param turtle
	...
	/**
	 * Turns an entities drops into TtemStacks Credit: austinv11
	 * 
	 * @param entities
	...
	/**
	 * Finds the center to use for clicking a block Credit: Cypher121, modified
	 * on 2/5/2016
	 * 
	 * @param dir
	 *        ForgeDirection which is being clicked from
	...
	/**
	 * Finds the center to use for clicking a block Credit: Cypher121
	 * 
	 * @param side
	 *        integer representing the side which is being clicked from
	 * @return a float array of the location
	 */
